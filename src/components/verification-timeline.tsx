...
import { CheckCircle, Fingerprint, GitMerge, Twitter, Calendar, Mail, Globe, MessageSquare, Shield, User } from 'lucide-react';
...
const eventDetails: { [key: string]: { icon: React.ElementType; label: string; color: string; bgColor: string } } = {
  ...
  email: { icon: Mail, label: 'Email Verified', color: 'text-cyan-400', bgColor: 'bg-cyan-500/20 border-cyan-400' },
  web: { icon: Globe, label: 'Website Verified', color: 'text-indigo-400', bgColor: 'bg-indigo-500/20 border-indigo-400' },
  website: { icon: Globe, label: 'Website Verified', color: 'text-indigo-400', bgColor: 'bg-indigo-500/20 border-indigo-400' },
  discord: { icon: MessageSquare, label: 'Discord Verified', color: 'text-violet-400', bgColor: 'bg-violet-500/20 border-violet-400' },
  matrix: { icon: MessageSquare, label: 'Matrix Verified', color: 'text-emerald-400', bgColor: 'bg-emerald-500/20 border-emerald-400' },
  profile_updated: { icon: User, label: 'Profile Updated', color: 'text-yellow-400', bgColor: 'bg-yellow-500/20 border-yellow-400' },
  security_check: { icon: Shield, label: 'Security Check', color: 'text-red-400', bgColor: 'bg-red-500/20 border-red-400' },
};
