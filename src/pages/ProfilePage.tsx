...
export default function ProfilePage() {
  if (Boolean(import.meta.env.VITE_APP_SIMPLE_SEARCH_DESIGN) == false) {
    var [activeTab, setActiveTab] = useState<ProfileTab>("contact")
    var [copiedField, setCopiedField] = useState<string | null>(null)

    var copyToClipboard = (text: string, field: string) => {
  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white">
      ...
      />
      {Boolean(import.meta.env.VITE_APP_SIMPLE_SEARCH_DESIGN) === false
        ? <>
